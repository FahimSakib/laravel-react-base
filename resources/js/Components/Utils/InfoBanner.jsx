...
export default function InfoBanner({ text = '', canHide = true, className = '' }) {
    ...
    return (
        <div className={'flex items-center justify-between p-4 bg-[#6366f1]/5 text-[#6c737f] dark:text-[#a0aec0] rounded-lg ' + className}>
