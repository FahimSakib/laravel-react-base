...
const AccessDenied = () => {
    return (
        <div className="max-w-7xl mx-auto mt-8 dark:text-[#edf2e7]">
            <h4 className="text-2xl md:text-3xl font- text-center">Permission Denied</h4>
            <p className="text-[#6c737f] dark:text-[#a0aec0] text-center pt-4 pb-8">You do not have permission to access this page</p>
            <svg
            ...
            >
                ...
                />
                <image
                    href="/assets/images/character_4.png"
                    height={300}
                    x={220}
                    y={30}
                />
                ...
                <defs>
                    ...
                    >
                        <stop stopColor="#B985F4" />
                        <stop offset={1} stopColor="#431A9E" />
                    </linearGradient>
                </defs>
            </svg>
        </div>
...
AccessDenied.layout = page => <Layout children={page} title="Access Denied" />
